...
<head>
    ...
    <link rel="stylesheet" href="assets4/css/Poppins.css">
    <link rel="stylesheet" href="assets4/fonts/fontawesome-all.min.css">
    <link rel="stylesheet" href="assets4/fonts/ionicons.min.css">
    <link rel="stylesheet" href="assets4/css/bs-theme-overrides.css">
    <link rel="stylesheet" href="assets4/css/Login-Form-Basic-icons.css">
    <link rel="stylesheet" href="assets4/css/Multiple-Input-Select-Pills.css">
    <link rel="stylesheet" href="assets4/css/progress-bars-progress.css">
    <link rel="stylesheet" href="assets4/css/Sign-Up-Form---Gabriela-Carvalho.css">
    ...
    <section style="background: #ffffff;border-top-left-radius: 37px;border-top-right-radius: 37px;">
        ...
        <div class="row" style="padding-bottom: 25px;">
            <div class="col" style="padding-left: 6dvw;padding-right: 0dvw;">
                <div class="btn btn-primary" style="width: -webkit-fill-available;">
            ...
            <div class="col" style="padding-left: 2dvw;padding-right: 6dvw;">
                <div class="btn btn-outline-primary" style="width: -webkit-fill-available;">
                    <!-- style="height: 67.8px;border-top-left-radius: 10px;border-top-right-radius: 10px;border-bottom-right-radius: 10px;border-bottom-left-radius: 10px;" -->
